...
<head>
    ...
    <link rel="stylesheet" href="css/salesUpdateOrderDetails.css">
    <script>

        function JSalert(Updated){
            swal({   title: "The order ID \"" + Updated + "\" is updated",
...
EOD;
    ...
    echo<<<EOD
<div class="table-users">
    <div class="header" ><a href="salesUpdateOrders.php"><input type="image" style="float: left;" src="css/images/imgBackBtn.png" height="40px" width="40px"  /> </a>Ordering item</div>
