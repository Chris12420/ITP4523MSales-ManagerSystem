...
<head>
  ...
  <!-- CSS -->
  <link rel="stylesheet" href="css/managerEditItems.css">

  <script>
      function JSalert(Updated){
          swal({   title: "The item ID \"" + Updated + "\" is Updated",
              ...
              function(isConfirm){
                  if (isConfirm)
                  {
                      location.href = 'managerEditItems.php';
                  }
                  else {
                  } });
      }
    ...
    <div class="smallTable">
        ...
        if(isset($_GET['itemID'])){
            ...
            }else
            {
                ...
                extract($rec);
                $formCode = <<<EOD
    <form action="managerEditItemsValidate.php" method="post" name="custInfo">
  <table cellspacing="0">
      <tr>
         <th>Item ID</th>
         <th>Item Name</th>
         ...
         <th>Price</th>
         <th><input type="submit" value="Update Record"</th>
      </tr>
      
      <tr>
         <th><input type="text" name="itemID" value="$itemID" readonly></th>
         <th><input type="text" name="itemName" value="$itemName" ></th>
         <th><input type="text" name="itemDescription" value="$itemDescription" ></th>
         <th><input type="text" name="stockQuantity" value="$stockQuantity" ></th>
         <th><input type="text" name="price" value="$price" ></th>
         <th><input type="button" value="Cancel" onclick="window.location.href='managerEditItems.php';"></th>
      </tr>
...
<form action="managerEditItems.php" method="post">
...
EOD;
    while ($rc = mysqli_fetch_assoc($rs)) {
        ...
        <tr>
         ...
         <td>$stockQuantity</td>
         <td>$price</td>
         <td id="hi"><a href="managerEditItems.php?itemID=$itemID">Update Record</td>
